...
for i in range(len(l1a_fnames)):
    ...
    call('modis_GEO -v -o ' + fname_geo + ' ' + l1a_fnames[i], shell=True)
    if (not os.path.exists(fname_geo)):
       call('modis_GEO -v --refreshDB -o ' + fname_geo + ' ' + l1a_fnames[i], shell=True)
    if (not os.path.exists(fname_geo)):
    ...
    call('modis_L1B -v -o ' + fname_l1b + ' ' + l1a_fnames[i]  + ' ' + fname_geo, shell=True)
    ...
    call('getanc -v ' + l1a_fnames[i] , shell=True)
