...
hawk_chl_array = read_hdf_prod('/Users/mitchtork/HawkEye_Eval/data/satellite_matchups/sensors/hawkeye/l2-l3/daily/chlor_a/mean/SEAHAWK1_HAWKEYE.2023050720230507.chlor_a-mean.smi.nc', 'chlor_a')
bad_loc = np.where(hawk_chl_array == fill_value)
hawk_chl_array[bad_loc] = np.nan

modisa_chl_array = read_hdf_prod('/Users/mitchtork/HawkEye_Eval/data/satellite_matchups/sensors/modisa/l2-l3/daily/chlor_a/mean/AQUA_MODIS.2023050720230507.chlor_a-mean.smi.nc', 'chlor_a')
bad_loc = np.where(modisa_chl_array == fill_value)
modisa_chl_array[bad_loc] = np.nan

S3A_chl_array = read_hdf_prod('/Users/mitchtork/HawkEye_Eval/data/satellite_matchups/sensors/s3a/l2-l3/daily/chlor_a/mean/S3A_OLCI_EFRNT.2023050720230507.chlor_a-mean.smi.nc', 'chlor_a')
bad_loc = np.where(S3A_chl_array == fill_value)
S3A_chl_array[bad_loc] = np.nan

S3B_chl_array = read_hdf_prod('/Users/mitchtork/HawkEye_Eval/data/satellite_matchups/sensors/s3b/l2-l3/daily/chlor_a/mean/S3B_OLCI_EFR.2023050620230506.chlor_a-mean.smi.nc', 'chlor_a')
