...
SAVE_DIR = os.path.join(BASE_DIR, 'visualization/contour_plots/wb/chlorophyll/3D_plots/individual_transects')
...
def plot_individual_transect_3d_chlorophyll_gradient(file_names, global_min, global_max):
...
def main():
    ...
    for idx in range(len(file_names)):
        plot_individual_transect_3d_chlorophyll_gradient(file_names, global_min, global_max)
