    ...
    for pixel_size in pixel_window_sizes:
        ...
        for depth_range in depth_ranges:
            ...
            if len(true_values) == len(predicted_values):
                ...
                sc = ax.scatter(true_values, predicted_values, c=z, s=15, cmap='viridis', edgecolor=None)
                cbar = plt.colorbar(sc, ax=ax, label='Density')
                cbar.set_label('Density', fontsize=colorbar_label_font_size)
                ...
                # Adding number of points (N) to the plot
                ax.annotate(f'N= {n_points}', xy=(0.95, 0.95), xycoords='axes fraction',
                            horizontalalignment='right', verticalalignment='top',
                            fontsize=annotation_font_size, bbox=dict(boxstyle='round,pad=0.5', fc='#FFFFFF', alpha=0.5))
