    ...
    for pixel_size in pixel_window_sizes:
        ...
        for depth_range in depth_ranges:
            ...
            if len(true_values) == len(predicted_values):
                ...
                cbar.ax.tick_params(labelsize=colorbar_font_size)  # Set the colorbar tick label size
                cbar.set_label('Density', fontsize=colorbar_font_size)  # Set the colorbar label size
