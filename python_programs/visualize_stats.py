...
for metric in metrics:
    ...
    plot.set_title(f'{metric} for Satellite Sensor by Depth Range, {pixel_window_size} Pixel Window Size, 7 May 2023')
    ...
    if labels:
        plt.legend(handles, labels, title='Depth Range of In-Situ Data')
